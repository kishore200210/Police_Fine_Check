...
country_name = st.sidebar.selectbox("Select Country", options=["All"] + sorted(df["country_name"].dropna().unique().tolist()))
...
if country_name != "All":
    filtered_df = filtered_df[filtered_df["country_name"] == country_name]
